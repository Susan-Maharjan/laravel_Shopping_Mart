...
@section('content')
 ...
 --}}
    ...
    <section class="brands">
        <div class="container">
            <h3 class="section-heading">Shop By Brand</h3>
            <div class="brand-slider">
                <div class="brand-item">
                    <div class="brand-logo">
                        <a href="#">
                            <img src="images/johnson.png" class="img-fluid" alt="memykid">
                        </a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-logo">
                        <a href="#">
                            <img src="images/pigeon.png" class="img-fluid" alt="memykid">
                        </a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-logo">
                        <a href="#">
                            <img src="images/nestle.png" class="img-fluid" alt="memykid">
                        </a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-logo">
                        <a href="#">
                            <img src="images/bugabo.png" class="img-fluid" alt="memykid">
                        </a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-logo">
                        <a href="#">
                            <img src="images/himalaya.png" class="img-fluid" alt="memykid">
                        </a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-logo">
                        <a href="#">
                            <img src="images/dove.png" class="img-fluid" alt="memykid">
                        </a>
                    </div>
                </div>
                <div class="brand-item">
